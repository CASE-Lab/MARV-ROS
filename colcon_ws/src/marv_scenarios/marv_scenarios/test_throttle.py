...
class Test_Throttle(Scenario):
    ...
    def __init__(self):
        ...
        super().__init__('test_throttle',__scenario_name,__data_var_1_header,__data_var_2_header)
    ...
    def main_loop_callback(self):
        ...
        if self.get_scenario_running():
            if self.node_test_timer.elapsed() == 0:
                ...
                self.set_cmd_steering_aps(3.75) # Set throttle value
                ...
                self.set_cmd_steering_aps(4.0)
                self.set_progress("2/3")
                self.get_logger().info("cmd_throttle: " + str(self.get_cmd_steering_aps()))

            elif self.node_test_timer.elapsed() > 6:
                self.set_cmd_steering_aps(4.5)
...
def main(args=None):
    ...
    rclpy.spin(test_throttle)

    test_throttle.destroy_node()
    rclpy.shutdown()
